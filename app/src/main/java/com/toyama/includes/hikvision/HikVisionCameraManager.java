package com.toyama.includes.hikvision;
...
public class HikVisionCameraManager {
    ...
    private String DVR_UNAME = "";
    private String DVR_PSWD = "";
    ...
    //Log into device. On successful registration returns a unique identifier user ID for other operations
